...
// =============================================================================
// === THIS IS THE CHANGE FOR REQUEST #1 =======================================
// =============================================================================
const STATUS_OPTIONS = [ "ATS Shortlisted", "L1 interview scheduled", "L1 Selected", "L1 Rejected", "L2 interview scheduled", "L2 Selected", "L2 Rejected", "HR scheduled", "HR Round Selected", "HR Round Rejected", "Document Verification Pending", "Documents Cleared", "Documents Rejected", "Offer Letter Issued", "Offer Letter On Hold", "Offer Accepted", "Offer Rejected", "Candidate Joined", "Candidate Not Joined", "Resume declined" ];
// =============================================================================
// =============================================================================
...
const STAGE_GROUPS = { SCREENING: ["ATS Shortlisted", "Resume declined"], L1_INTERVIEW: ["L1 interview scheduled", "L1 Selected", "L1 Rejected"], L2_INTERVIEW: ["L2 interview scheduled", "L2 Selected", "L2 Rejected"], HR_ROUND: ["HR scheduled", "HR Round Selected", "HR Round Rejected"], DOCUMENT_VERIFICATION: ["Document Verification Pending", "Documents Cleared", "Documents Rejected"], OFFER: ["Offer Letter Issued", "Offer Accepted", "Offer Rejected", "Candidate Not Joined", "Offer Letter On Hold"], JOINED: ["Candidate Joined"],};
